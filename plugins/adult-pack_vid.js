...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw `*『✦』Los comandos para adultos no estan activos.*`
try{ 
switch (command) {  
...
await conn.reply(m.chat, `Reporte a este comando con: #report no funciona el siguiente comando ${usedPrefix + command}\n\n${wm}`, fkontak, m)
console.log(e)}
}

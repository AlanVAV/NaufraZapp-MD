...
const fload = { key : { message: `NaufraZapp-MD` + `\nNaufrago`, thumbnail: await (await fetch(pp)).buffer(), sellerJid: '0@s.whatsapp.net' }}

m.react('👋🏻')
  
let menu = `👀 *Hola usuario/a: ${user}*
Gracias por estar aqui. ✨

💭 Puedes ir al menu presionando el botón ❤️
...
//await conn.reply(m.chat, menu, a, { contextInfo: { externalAdReply: {title: '🎊 Hola' + user + '🥳', body: wm, sourceUrl: ig, thumbnail: await (await fetch(pp)).buffer() }}})

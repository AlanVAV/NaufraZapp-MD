const handler = async (m, {conn, participants, command, usedPrefix}) => {
  ...
  if (m.message.extendedTextMessage === undefined || m.message.extendedTextMessage === null) return m.reply('『✦』Etiquete, mensione o responda al mensaje del participante para eliminarlo.');

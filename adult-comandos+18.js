...
let frep = { contextInfo: { externalAdReply: {title: wm, body: menusNZ4.getRandom(), sourceUrl: redesNZ1.getRandom(), thumbnail: await(await fetch(img3)).buffer() }}}
...
await conn.sendFile(m.chat, enlace, null, `『✦』Disfrute de su contenido.\n\n${wm}`, null, null, {viewOnce: true}, m)}
...
await conn.sendFile(m.chat, res, null, `『✦』Disfrute de su contenido.\n\n${wm}`, null, null, {viewOnce: true}, m)}
...
await conn.sendFile(m.chat, null, null, `『✦』Disfrute de su contenido.\n\n${wm}`, null, null, {viewOnce: true}, m)
...
await conn.sendFile(m.chat, link, null, `『✦』Disfrute de su contenido.\n\n${wm}`, null, null, {viewOnce: true}, m)}}
...
await conn.reply(m.chat, `Error, intentalo de nuevo.\n\n${wm}`, m)
console.log(e)}
}  
